...
<%@ page
	import="model.Employee, java.text.SimpleDateFormat, java.util.Date, java.util.Calendar"%>
...
<body>
	...
	<div class="footer_design">
		<footer>
			<small>© 2021 Education inc.</small>
		</footer>
	</div>
</body>
</html>
